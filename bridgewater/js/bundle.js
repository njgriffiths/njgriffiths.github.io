...
module.exports = [{"id":"education","title":"Educating the Next Generation","imageName":"cs-education","url":"","text":"Bridgewater prides itself as a community where energy knowledge and education is freely available.  Whether it’s the annual “Growing Green Festival,” the 2017 “Energize Nova Scotia Discovery Fair” or energy education in local schools, educating and engaging the community and especially the next generation is a critical part of developing a clean energy economy."},{"id":"school","title":"Small World Learning Center","imageName":"cs-daycare","url":"","text":"Small World was looking to expand but was concerned about increased energy costs. With support from Efficiency Nova Scotia, they focused their spending on heating systems, appliances, lighting, and extra insulation – leading to a 75% reduction in their energy bills. That translates into nearly $5000 a year that is being reinvested into programming for the kids."},{"id":"home","title":"Eason Family Home Reno","imageName":"cs-eason","url":"","text":"The Eason’s well-loved older home was drafty and their heating bills were very high. They signed up for the town’s Clean Energy Financing program, which gave them access to up to low interest financing to do energy upgrades to the home. About $9000 later, their home energy costs were reduced by nearly $2000 per year, and their home was more comfortable, especially their childrens’ bedrooms. The financing is tied to the property, so it stays with the home even if they sell it."}]

/***/ }),
/* 6 */
/***/ (function(module, exports) {

module.exports = [{"group":"town","title":"Community Capacity Builder","imageName":"case-study","url":"","text":"The Town’s first priority is to build its capacity to implement the Community Energy Investment Plan and to empower community partners to exercise leadership."},{"group":"town","title":"Clean Energy Enabler","imageName":"case-study","url":"","text":"The Town will undertake a series of enabling actions to make sure that clean energy initiatives are not slowed down by red tape, and to allow residents and community partners to pursue their own energy investments."},{"group":"town","title":"Clean Energy Investor","imageName":"case-study","url":"","text":"The Town will invest in clean energy opportunities on a community scale, as well as for its municipal operations."},{"group":"residents","title":"Increase Energy Awareness","imageName":"case-study","url":"","text":"Continue learning about the benefits and practical applications of clean energy solutions for home, work, school, and community."},{"group":"residents","title":"Home Energy Retrofits","imageName":"case-study","url":"","text":"Upgrade  homes with cost-effective clean energy technologies and practice low-cost energy conservation habits."},{"group":"residents","title":"Use Clean Transportation","imageName":"case-study","url":"","text":"Take public transit, use active means of transportation (walking, cycling, wheeling), utilize transportation sharing services, and invest in electric vehicles."},{"group":"business","title":"Building Retrofits","imageName":"case-study","url":"","text":"Businesses and organizations can upgrade their facilities with cost-effective clean energy technologies and practice low-cost energy conservation habits."},{"group":"business","title":"Invest in Clean Enery Projects","imageName":"case-study","url":"","text":"Businesses and organizations can take advantage of local investment programs that will be started by the Town of Bridgewater and the Energy Partners."},{"group":"business","title":"Energy-related skills training","imageName":"case-study","url":"","text":"Increase training for staff in current energy technologies and best practices, assign staff to energy management activities, and participate in local clean energy opportunities."}]
...
module.exports = (Handlebars['default'] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<h3><span class=\"bold\">Case Study:</span> "
    ...
    + "</h3>\n\n<div class=\"media float-left\">\n	<picture>\n		<source srcset=\"img/case-studies/"
    ...
    + "-mobile.jpg\" media=\"(max-width: 640px)\">\n		<source srcset=\"img/case-studies/"
    + alias4(((helper = (helper = helpers.imageName || (depth0 != null ? depth0.imageName : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"imageName","hash":{},"data":data}) : helper)))
    + "-web.jpg\" media=\"(min-width: 640px)\">\n		<img srcset=\"img/case-studies/"
    + alias4(((helper = (helper = helpers.imageName || (depth0 != null ? depth0.imageName : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"imageName","hash":{},"data":data}) : helper)))
